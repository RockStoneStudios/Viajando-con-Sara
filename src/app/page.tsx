...
export default function Home() {
    return (
        ...
        className="fixed bottom-4 right-4 z-50 bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition-colors duration-300 md:p-4
                    max-[370px]:right-2 max-[370px]:bottom-2"
